 ...
 * This file demonstrates how to integrate Xendrift with a web frontend
 */

// For React/Vue/Angular applications
export class XendriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new XendriftClient(provider, contractAddress);
